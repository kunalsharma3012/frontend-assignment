...
export default function HomePage() {
  ...
  const [selectedDepartment, setSelectedDepartment] = useState("Marketing");  // Default to Marketing


  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      {/* Header */}
      <Navbar selectedDepartment={selectedDepartment} setSelectedDepartment={setSelectedDepartment}/>
    ...
    <PiSealQuestion size={20} className="text-white" />
          ...
          <div className="border border-[#1193ad] my-3 mr-16 p-4 flex items-start gap-4">
            ...
            <p className="text-[14px] text-[#1193ad]">
              ...
              or services to customers. It involves researching customer needs
              and wants, developing products and services that meet those needs,
              pricing products and services appropriately, creating marketing
              materials to promote products and services, and distributing those
              materials through various channels to reach potential customers.
              The ultimate goal of marketing is to generate interest and
  ...
  <button className="bg-[#1193ad] text-white flex items-center pl-2 pr-4  py-2 rounded max-w-2xl">
    ...
    offer services like social media marketing, content marketing, and
...
<div className="pr-6 text-[#1193ad]  rounded-lg">
  <div className="relative ">
    ...
    <PiSealQuestion className="absolute left-2 top-1/2 transform -translate-y-1/2 text-[#1193ad]" size={25} />
    ...
    <GoPaperAirplane className="absolute right-2 top-1/2 transform -translate-y-1/2 text-[#1193ad]" size={25} />
  </div>
</div>
<p className="text-sm text-gray-400 mx-16 mt-10">Type your next question above or select one from the related questions section</p>
        </main>
      </div>
    </div>
  );
